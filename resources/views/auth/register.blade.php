                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-7">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header"><h3 class="text-center font-weight-light my-4">Create Account H R I S</h3></div>
                                <div class="card-body">
                                ...
                                <div class="card-footer text-center">
                                    <div class="small">
                                        <a href="{{ route('login') }}" class="text-center">Have an account? Go to login</a>
                                    </div>
                                </div>
                            </div>
                        </div>
